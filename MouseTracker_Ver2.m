function varargout = MouseTracker_Ver2(varargin)
% MOUSETRACKER_VER2 MATLAB code for MouseTracker_Ver2.fig
%      MOUSETRACKER_VER2, by itself, creates a new MOUSETRACKER_VER2 or raises the existing
%      singleton*.
%
%      H = MOUSETRACKER_VER2 returns the handle to a new MOUSETRACKER_VER2 or the handle to
%      the existing singleton*.
%
%      MOUSETRACKER_VER2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MOUSETRACKER_VER2.M with the given input arguments.
%
%      MOUSETRACKER_VER2('Property','Value',...) creates a new MOUSETRACKER_VER2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before MouseTracker_Ver2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to MouseTracker_Ver2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help MouseTracker_Ver2

% Last Modified by GUIDE v2.5 25-Feb-2021 16:22:28

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @MouseTracker_Ver2_OpeningFcn, ...
                   'gui_OutputFcn',  @MouseTracker_Ver2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
%     [varargout{1:nargout}] = MouseTracker_Ver2_OpeningFcn(gui_State, varargin{:});
else
    gui_mainfcn(gui_State, varargin{:});
%     MouseTracker_Ver2_OpeningFcn(gui_State, varargin{:});
end
% End initialization code - DO NOT EDIT


% --- Executes just before MouseTracker_Ver2 is made visible.
function MouseTracker_Ver2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to MouseTracker_Ver2 (see VARARGIN)

% Choose default command line output for MouseTracker_Ver2
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes MouseTracker_Ver2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = MouseTracker_Ver2_OutputFcn(hObject, eventdata, handles) 
...
switch SelectedAlgorithm
   ...
   case 'MiceMovieAnalyzerCJM_2018_derivative'
      [MissedFrame,MouseLoc,InteractionTimes,CompartmentTimes,firstFrame,...
          LastFrame]=MiceMovieAnalyzerCJM_2018_derivative(Movie_fn,...
          HandlesForGUIControls,StartingFrame,EndingFrame,...
          AllExcludedAreas,CompartmentsPositions,InteractionZones,...
          SaveMovie,ThresholdValue,MousePixelSize,dsFactor);
      set(HandlesForGUIControls.StatusBar,'string','Finished analyzing');
...
Film = VideoReader(Movie_fn);
Clean_cdataWB = bwareaopen(sum(imbinarize(read(Film,StartingFrame)-read(Film,StartingFrame+1)),3),MousePixelSize);
...
[~,idx] = max(cellfun(@numel,BoundariesWB));
BoundariesWB = BoundariesWB(idx);
axes(HandlesForGUIControls.axes1);
hold on;

%get the largest, that's what you'll use
